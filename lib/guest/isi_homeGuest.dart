...
class IsiHomeGuest extends StatefulWidget {
  ...
  @override
  State<IsiHomeGuest> createState() => _IsiHomeGuestState();
}

class _IsiHomeGuestState extends State<IsiHomeGuest> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      buildMenuItem(
                          Icons.list_alt_outlined, 'Pesanan', const Color.fromRGBO(116, 234, 163, 100)),
                      SizedBox(
                        height: 16,
                      ),
      ...
      onTap: () {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            title: Text('Lakukan Login',
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 18,
                    color: Colors.pink[400])),
            content: Text(
              'Anda harus login terlebih dahulu untuk mengakses "$title".',
